...
auto main() -> int {
    ...
    static auto mutex0 = rtos::Mutex();
    static auto mutex1 = rtos::Mutex();
    ...
    [[maybe_unused]] static auto task_med_pri = rtos_test::TaskWithStack(1, false, []{
    ...
    [[maybe_unused]] static auto task_low_pri = rtos_test::TaskWithStack(0, false, []{
